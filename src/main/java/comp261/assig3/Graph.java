...
public class Graph {
    ...
    // Applied to edge weights to account for vehicle type
    public int vehicleTypeMulti = 1;
    ...
    // Getter for vehicleTypeMulti
    public int getVehicleTypeMulti() {
        return vehicleTypeMulti;
    }

    // Getter for vehicleTypeMulti
    public void setVehicleTypeMulti(int vehicleTypeMulti) {
        this.vehicleTypeMulti = vehicleTypeMulti;
    }
}
